      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 my-5 md:my-20">
        <div className=" p-10 w-[400px] ">
          ...
          <p className="text-xl mt-5">
            ...
            would be. SolutionBD was able to complete the job just as I imagined
            it to be. Thanks to them, they made it possible. - Partner Flyout
            BD’’
          </p>
        </div>
        ...
        <div className=" p-10 w-[400px]">
          ...
          <p className="text-xl mt-5">
            ...
            parlor. So, I downloaded SolutionBD app and found that it has all of
            my requirements. The beautician arrived in time and was really
            amazing. Thank you.’’
          </p>
        </div>
      </div>
